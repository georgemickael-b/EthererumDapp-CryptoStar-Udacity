...
contract StarNotary is ERC721 {
    ...
    string public name = "GNE Not Ether";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require( owner1 == msg.sender ||  owner2 == msg.sender, "Sorry. You don't own either of the stars.");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require( ownerOf(_tokenId) == msg.sender, "Sorry. You don't own that star.");
